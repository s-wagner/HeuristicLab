...
namespace HeuristicLab.Services.OKB.Query.Filters {
  public class RunUserNameFilter : IFilter {
    ...
    public RunUserNameFilter(DataTransfer.StringComparison comparison, string value) {
      Comparison = comparison;
      Value = value;
    }
    public RunUserNameFilter(DataTransfer.StringComparisonFilter filter) {
