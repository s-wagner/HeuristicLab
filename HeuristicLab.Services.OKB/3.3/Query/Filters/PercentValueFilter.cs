...
namespace HeuristicLab.Services.OKB.Query.Filters {
  public class PercentValueFilter : IFilter {
    ...
    public PercentValueFilter(string name, DataTransfer.OrdinalComparison comparison, double value) {
      Name = name;
      Comparison = comparison;
      Value = value;
    }
    public PercentValueFilter(DataTransfer.NameOrdinalComparisonPercentFilter filter) {
      Name = filter.Name;
