...
namespace HeuristicLab.Services.OKB.Query.Filters {
  public class ProblemDataTypeNameFilter : IFilter {
    ...
    public ProblemDataTypeNameFilter(DataTransfer.StringComparison comparison, string value) {
      Comparison = comparison;
      Value = value;
    }
    public ProblemDataTypeNameFilter(DataTransfer.StringComparisonFilter filter) {
