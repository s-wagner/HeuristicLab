...
namespace HeuristicLab.Services.OKB.Query.Filters {
  public class AlgorithmDataTypeNameFilter : IFilter {
    ...
    public AlgorithmDataTypeNameFilter(DataTransfer.StringComparison comparison, string value) {
      Comparison = comparison;
      Value = value;
    }
    public AlgorithmDataTypeNameFilter(DataTransfer.StringComparisonFilter filter) {
