  ...
  public class AndFilter : IFilter {
    ...
    public Expression<Func<Run, bool>> Expression {
      get {
        ...
        Expression expr = System.Linq.Expressions.Expression.Constant(true);
        foreach (IFilter filter in Filters)
          expr = System.Linq.Expressions.Expression.AndAlso(expr, System.Linq.Expressions.Expression.Invoke(filter.Expression, parameter));
    ...
    public AndFilter(DataTransfer.CombinedFilter filter) {
