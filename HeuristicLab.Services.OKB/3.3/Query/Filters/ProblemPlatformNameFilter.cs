...
namespace HeuristicLab.Services.OKB.Query.Filters {
  public class ProblemPlatformNameFilter : IFilter {
    ...
    public ProblemPlatformNameFilter(DataTransfer.StringComparison comparison, string value) {
      Comparison = comparison;
      Value = value;
    }
    public ProblemPlatformNameFilter(DataTransfer.StringComparisonFilter filter) {
