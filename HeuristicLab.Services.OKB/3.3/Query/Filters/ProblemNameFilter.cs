...
namespace HeuristicLab.Services.OKB.Query.Filters {
  public class ProblemNameFilter : IFilter {
    ...
    public ProblemNameFilter(DataTransfer.StringComparison comparison, string value) {
      Comparison = comparison;
      Value = value;
    }
    public ProblemNameFilter(DataTransfer.StringComparisonFilter filter) {
