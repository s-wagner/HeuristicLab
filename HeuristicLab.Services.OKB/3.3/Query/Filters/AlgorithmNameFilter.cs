...
namespace HeuristicLab.Services.OKB.Query.Filters {
  public class AlgorithmNameFilter : IFilter {
    ...
    public AlgorithmNameFilter(DataTransfer.StringComparison comparison, string value) {
      Comparison = comparison;
      Value = value;
    }
    public AlgorithmNameFilter(DataTransfer.StringComparisonFilter filter) {
