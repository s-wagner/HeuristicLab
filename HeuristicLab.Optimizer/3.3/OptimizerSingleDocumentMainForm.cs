...
namespace HeuristicLab.Optimizer {
  internal partial class OptimizerSingleDocumentMainForm : SingleDocumentMainForm {
    ...
    public OptimizerSingleDocumentMainForm()
      : base() {
      InitializeComponent();
    }
    public OptimizerSingleDocumentMainForm(Type userInterfaceItemType)
      : base(userInterfaceItemType) {
      InitializeComponent();
    }
    public OptimizerSingleDocumentMainForm(Type userInterfaceItemType, bool showContentInViewHost)
