...
namespace HeuristicLab.ExactOptimization {
  ...
  [Plugin("HeuristicLab.ExactOptimization", "Provides support for exact optimization based on Google OR-Tools. " +
    "Requires the Microsoft Visual C++ 2017 Redistributable (x64) - 14.16.27012: https://aka.ms/vs/15/release/vc_redist.x64.exe", "3.3.16.17186")]
  ...
  [PluginDependency("HeuristicLab.OrTools", "7.0")]
