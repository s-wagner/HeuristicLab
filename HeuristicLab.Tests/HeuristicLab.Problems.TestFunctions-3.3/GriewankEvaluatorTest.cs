...
namespace HeuristicLab.Problems.TestFunctions.Tests {
  /// <summary>
  ///This is a test class for GriewankEvaluatorTest and is intended
  ///to contain all GriewankEvaluatorTest Unit Tests
  ///</summary>
  [TestClass()]
  public class GriewankEvaluatorTest {
    /// <summary>
    ...
    public void GriewankEvaluateFunctionTest() {
      GriewankEvaluator_Accessor target = new GriewankEvaluator_Accessor();
