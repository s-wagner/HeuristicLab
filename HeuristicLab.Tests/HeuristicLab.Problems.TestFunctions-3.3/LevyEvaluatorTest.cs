...
namespace HeuristicLab.Problems.TestFunctions.Tests {
  /// <summary>
  ///This is a test class for LevyEvaluatorTest and is intended
  ///to contain all LevyEvaluatorTest Unit Tests
  ///</summary>
  [TestClass()]
  public class LevyEvaluatorTest {
    /// <summary>
    ...
    public void LevyEvaluateFunctionTest() {
      LevyEvaluator_Accessor target = new LevyEvaluator_Accessor();
