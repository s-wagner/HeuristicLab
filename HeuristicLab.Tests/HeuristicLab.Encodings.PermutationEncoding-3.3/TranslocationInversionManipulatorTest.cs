...
namespace HeuristicLab.Encodings.PermutationEncoding.Tests {
  /// <summary>
  ///This is a test class for TranslocationInversionManipulator and is intended
  ///to contain all TranslocationInversionManipulator Unit Tests
  ///</summary>
  [TestClass()]
  public class TranslocationInversionManipulatorTest {
    /// <summary>
    ///A test for Apply
    ///</summary>
    [TestMethod]
