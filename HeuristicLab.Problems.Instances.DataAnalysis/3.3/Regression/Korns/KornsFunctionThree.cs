...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class KornsFunctionThree : ArtificialRegressionDataDescriptor {

    public override string Name { get { return "Korns 3 y = -5.41 + (4.9 * (((X3 - X0) + (X1 / X4)) / (3 * X4)))"; } }
    ...
    public KornsFunctionThree() : this((int)System.DateTime.Now.Ticks) {
    }
    public KornsFunctionThree(int seed) : base() {
      Seed = seed;
    }
