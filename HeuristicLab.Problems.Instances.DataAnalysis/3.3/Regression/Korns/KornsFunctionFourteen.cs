...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class KornsFunctionFourteen : ArtificialRegressionDataDescriptor {

    public override string Name { get { return "Korns 14 y = 22.0 + (4.2 * ((cos(X0) - tan(X1)) * (tanh(X2) / sin(X3))))"; } }
    ...
    public KornsFunctionFourteen() : this((int)System.DateTime.Now.Ticks) {
    }
    public KornsFunctionFourteen(int seed) : base() {
      Seed = seed;
    }
