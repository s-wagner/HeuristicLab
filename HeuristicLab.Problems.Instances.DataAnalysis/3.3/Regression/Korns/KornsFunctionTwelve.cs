...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class KornsFunctionTwelve : ArtificialRegressionDataDescriptor {

    public override string Name { get { return "Korns 12 y = 2.0 - (2.1 * (cos(9.8 * X0) * sin(1.3 * X4)))"; } }
    ...
    public KornsFunctionTwelve() : this((int)System.DateTime.Now.Ticks) {
    }
    public KornsFunctionTwelve(int seed) : base() {
      Seed = seed;
    }
