...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class KornsFunctionFour : ArtificialRegressionDataDescriptor {

    public override string Name { get { return "Korns 4 y = -2.3 + (0.13 * sin(X2))"; } }
    ...
    public KornsFunctionFour(int seed) : base() {
      Seed = seed;
    }
