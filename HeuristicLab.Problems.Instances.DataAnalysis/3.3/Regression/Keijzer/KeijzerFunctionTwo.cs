...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class KeijzerFunctionTwo : ArtificialRegressionDataDescriptor {

    public override string Name { get { return "Keijzer 2 f(x) = 0.3 * x *sin(2 * PI * x); Interval [-2, 2]"; } }
    public override string Description {
      get {
        ...
        + "range(train): x = [-2:0.1:2]" + Environment.NewLine
        + "range(test): x = [-2:0.001:2]" + Environment.NewLine
    ...
    protected override int TrainingPartitionEnd { get { return 41; } }
    protected override int TestPartitionStart { get { return 41; } }
    protected override int TestPartitionEnd { get { return 4042; } }
