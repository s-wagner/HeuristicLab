...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class CF4 : ResourceRegressionDataDescriptor {
    public CF4() : base("CF4.csv") { }
    public override string Name { get { return "CF4"; } }
    public override string Description {
      get {
        return "Coefficient of friction, Publication: E. Lughofer, G. K. Kronberger, M. Kommenda, S. Saminger-Platz, " +
    ...
    protected override int TrainingPartitionEnd { get { return 437; } }
    protected override int TestPartitionStart { get { return 437; } }
    protected override int TestPartitionEnd { get { return 649; } }
  }
}
