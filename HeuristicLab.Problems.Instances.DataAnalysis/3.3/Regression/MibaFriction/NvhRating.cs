...
namespace HeuristicLab.Problems.Instances.DataAnalysis {
  public class NvhRating : ResourceRegressionDataDescriptor {
    ...
    public override string Description {
      get {
        return "Noise-vibration-harshness rating (1..8), Publication: E. Lughofer, G. K. Kronberger, M. Kommenda, S. Saminger-Platz, " +
    ...
    protected override int TrainingPartitionEnd { get { return 2636; } }
    protected override int TestPartitionStart { get { return 2636; } }
    protected override int TestPartitionEnd { get { return 3943; } }
  }
}
