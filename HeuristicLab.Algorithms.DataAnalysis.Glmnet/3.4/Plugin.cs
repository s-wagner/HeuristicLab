...
namespace HeuristicLab.Algorithms.DataAnalysis {
  ...
  /// </summary>
  [Plugin("HeuristicLab.Algorithms.DataAnalysis.Glmnet", "Plugin class for HeuristicLab.Algorithms.DataAnalysis.Glmnet plugin which wraps the glmnet implementation by Jerome Friedman, Trevor Hastie, Noah Simon, Rob Tibshirani, see https://cran.r-project.org/web/packages/glmnet/index.html", "3.4.2.17186")]
  ...
  [PluginFile("glmnet-license-gpl2.txt", PluginFileType.License)]
  ...
  public class HeuristicLabAlgorithmsDataAnalysisGlmnetPlugin : PluginBase {
  }
}
