...
namespace HeuristicLab.Problems.Programmable.Views {
  [View("Multi-Objective Programmable Problem View")]
  [Content(typeof(MultiObjectiveProgrammableProblem), true)]
  public partial class MultiObjectiveProgrammableProblemView : ItemView {
    protected ViewHost ScriptView;

    public new MultiObjectiveProgrammableProblem Content {
      get { return (MultiObjectiveProgrammableProblem)base.Content; }
      set { base.Content = value; }
    }

    public MultiObjectiveProgrammableProblemView() {
      InitializeComponent();
