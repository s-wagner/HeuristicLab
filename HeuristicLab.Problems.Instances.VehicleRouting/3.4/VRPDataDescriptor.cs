...
namespace HeuristicLab.Problems.Instances.VehicleRouting {
  internal class VRPDataDescriptor : IDataDescriptor {
    ...
    internal VRPDataDescriptor(string name, string description, string instanceIdentifier, string solutionIdentifier) {
      this.Name = name;
