...
namespace HeuristicLab.Problems.Instances.Scheduling {
  internal class JSSPORLIBDataDescriptor : IDataDescriptor {
    ...
    internal JSSPORLIBDataDescriptor(string name, string description, string instanceIdentifier, string solutionIdentifier) {
      this.Name = name;
