...
namespace HeuristicLab.Problems.BinPacking {
  /// <summary>
  /// Plugin class for HeuristicLab.Problems.BinPacking plugin.
  /// </summary>
  [Plugin("HeuristicLab.Problems.BinPacking", "3.3.16.17186")]
  [PluginFile("HeuristicLab.Problems.BinPacking-3.3.dll", PluginFileType.Assembly)]
  ...
  public class HeuristicLabProblemsBinPackingPlugin : PluginBase {
  }
}
