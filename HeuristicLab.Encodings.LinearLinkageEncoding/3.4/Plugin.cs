...
namespace HeuristicLab.Encodings.LinearLinkageEncoding {
  [Plugin("HeuristicLab.Encodings.LinearLinkageEncoding", "Provides data structures and operators for the linear linkage encoding (LLE).", "3.4.15.17186")]
  ...
  public class HeuristicLabEncodingsLinearLinkageEncodingPlugin : PluginBase { }
}
