...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic.Classification.Views {
  [Plugin("HeuristicLab.Problems.DataAnalysis.Symbolic.Classification.Views","Provides views for symbolic classification problem classes.", "3.4.11.15587")]
  ...
  [PluginDependency("HeuristicLab.EPPlus", "4.0.1")]
  ...
  public class HeuristicLabProblemsDataAnalysisSymbolicClassificationViewsPlugin : PluginBase {
  }
}
