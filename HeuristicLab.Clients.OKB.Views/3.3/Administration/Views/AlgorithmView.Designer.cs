...
namespace HeuristicLab.Clients.OKB.Administration {
  partial class AlgorithmView {
    ...
    private void InitializeComponent() {
      ...
      this.algorithmClassLabel = new System.Windows.Forms.Label();
      this.algorithmClassComboBox = new System.Windows.Forms.ComboBox();
      ...
      // algorithmClassLabel
      // 
      this.algorithmClassLabel.AutoSize = true;
      this.algorithmClassLabel.Location = new System.Drawing.Point(3, 111);
      this.algorithmClassLabel.Name = "algorithmClassLabel";
      this.algorithmClassLabel.Size = new System.Drawing.Size(81, 13);
      this.algorithmClassLabel.TabIndex = 7;
      this.algorithmClassLabel.Text = "&Algorithm Class:";
      // 
      // algorithmClassComboBox
      // 
      this.algorithmClassComboBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                  | System.Windows.Forms.AnchorStyles.Right)));
      this.algorithmClassComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.algorithmClassComboBox.FormattingEnabled = true;
      this.algorithmClassComboBox.Location = new System.Drawing.Point(90, 108);
      this.algorithmClassComboBox.Name = "algorithmClassComboBox";
      this.algorithmClassComboBox.Size = new System.Drawing.Size(543, 21);
      this.algorithmClassComboBox.TabIndex = 8;
      this.algorithmClassComboBox.SelectedValueChanged += new System.EventHandler(this.algorithmClassComboBox_SelectedValueChanged);
      // 
      // tabControl
      // 
      ...
      this.usersTabPage.Controls.Add(this.refreshableLightweightUserView);
      ...
      this.refreshableLightweightUserView.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                  | System.Windows.Forms.AnchorStyles.Left)
                  | System.Windows.Forms.AnchorStyles.Right)));
      this.refreshableLightweightUserView.BackColor = System.Drawing.Color.Transparent;
      ...
      this.refreshableLightweightUserView.Location = new System.Drawing.Point(6, 6);
      ...
      this.refreshableLightweightUserView.Size = new System.Drawing.Size(613, 168);
      this.refreshableLightweightUserView.TabIndex = 3;
      this.refreshableLightweightUserView.SelectedUsersChanged += new System.EventHandler(this.refreshableLightweightUserView_SelectedUsersChanged);
      // 
      // dataTabPage
      // 
      ...
      this.dataTabPage.Text = "Platform-Specific Algorithm Data";
      ...
      this.toolTip.SetToolTip(this.saveFileButton, "Save Algorithm Data into File");
      ...
      this.toolTip.SetToolTip(this.openFileButton, "Load Algorithm Data from File");
      ...
      this.toolTip.SetToolTip(this.newDataButton, "Create New Algorithm Data");
      ...
      this.toolTip.SetToolTip(this.storeDataButton, "Store Algorithm Data");
      ...
      this.toolTip.SetToolTip(this.refreshDataButton, "Refresh Algorithm Data");
      ...
      this.openFileDialog.Title = "Load Algorithm Data";
      // 
      // saveFileDialog
      // 
      this.saveFileDialog.FileName = "data";
      this.saveFileDialog.Filter = "All Files (*.*)|*.*";
      this.saveFileDialog.Title = "Save Algorithm Data";
      // 
      // AlgorithmView
      // 
      ...
      this.Controls.Add(this.algorithmClassComboBox);
      this.Controls.Add(this.algorithmClassLabel);
      this.Name = "AlgorithmView";
      this.Size = new System.Drawing.Size(633, 445);
      this.Controls.SetChildIndex(this.algorithmClassLabel, 0);
      this.Controls.SetChildIndex(this.algorithmClassComboBox, 0);
    ...
    private System.Windows.Forms.Label algorithmClassLabel;
