...
namespace HeuristicLab.Problems.OneMax.Views {
  /// <summary>
  /// Plugin class for HeuristicLab.Problems.OneMax.Views plugin
  /// </summary>
  [Plugin("HeuristicLab.Problems.OneMax.Views", "3.3.11.12009")]
  [PluginFile("HeuristicLab.Problems.OneMax.Views-3.3.dll", PluginFileType.Assembly)]
  ...
  [PluginDependency("HeuristicLab.Problems.OneMax", "3.3")]
