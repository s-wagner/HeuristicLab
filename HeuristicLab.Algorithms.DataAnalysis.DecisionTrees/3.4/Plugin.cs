...
namespace HeuristicLab.Algorithms.DataAnalysis {
  ...
  /// Plugin class.
  /// </summary>
  [Plugin("HeuristicLab.Algorithms.DataAnalysis.DecisionTrees", "Provides algorithms for decision trees for regression", "3.4.0.17181")]
  [PluginFile("HeuristicLab.Algorithms.DataAnalysis.DecisionTrees-3.4.dll", PluginFileType.Assembly)]
  [PluginDependency("HeuristicLab.ALGLIB", "3.15")]
