...
namespace HeuristicLab.AutoDiff {
  [Plugin("HeuristicLab.AutoDiff","HeuristicLab wrapper for AutoDiff library that provides fast, accurate and automatic differentiation (derivative) of mathematical functions.","1.0.0.17181")]  
