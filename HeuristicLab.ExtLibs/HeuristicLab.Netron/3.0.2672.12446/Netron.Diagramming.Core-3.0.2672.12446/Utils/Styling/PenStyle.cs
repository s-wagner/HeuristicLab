...
namespace Netron.Diagramming.Core {
  // ----------------------------------------------------------------------
  /// <summary>
  /// Basic <see cref="IPenStyle"/> implementation; this is the minimal 
  /// structure for a pen, add other <see cref="Pen"/> properties as needed.
  /// </summary>
  // ----------------------------------------------------------------------
  public partial class PenStyle : IPenStyle {
    ...
    /// </summary>
    // ------------------------------------------------------------------
    protected const double penStyleVersion = 1.0;
