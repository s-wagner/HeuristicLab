...
namespace Netron.Diagramming.Core
{
    ...
    public class HorizontalRuler : RulerBase
    {
        ...
        public override void Paint(Graphics g)
        {
            ...
            g.FillRectangle(ArtPalette.RullerFillBrush, rec);
            ...
            while (!flag1)
            {
                ...
                if (f7 > 4.0F)
                {
                    ...
                    {
                        g.DrawLine(ArtPalette.RulerPen, f8, f3, f8, f4);
                        if (flag2)
                        {
            ...
            g.DrawRectangle(ArtPalette.RulerPen, rec.X, rec.Y, rec.Width, rec.Height);
