...
namespace Netron.Diagramming.Core {
  ...
  /// </summary>
  // ----------------------------------------------------------------------
  public class AlignTool : AbstractTool {
    ...
    // ------------------------------------------------------------------
    /// <summary>
    /// Gets or sets the type of alignment to apply.
    /// </summary>
    // ------------------------------------------------------------------
    ...
    protected override void OnActivateTool() {
      ...
      if (valid) {
        UngroupCommand cmd = new UngroupCommand(
            this.Controller,
           this.Controller.Model.Selection.SelectedItems[0] as IGroup);
