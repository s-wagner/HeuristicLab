...
namespace Netron.Diagramming.Core {
  /// <summary>
  /// The base class for a drawing tool.
  /// </summary>
  public abstract class AbstractDrawingTool :
    ...
    // ------------------------------------------------------------------
    /// <summary>
    /// The actual rectangle which serves as a basis for the drawing of 
    ...
    protected override void OnActivateTool() {
      ...
      Controller.View.CurrentCursor = CursorPalette.Add;
