...
namespace Netron.Diagramming.Core {
  ...
  class ScribbleTool : AbstractTool, IMouseListener, IKeyboardListener {
    ...
    #region Constructor
    /// <summary>
    /// Initializes a new instance of the <see cref="T:ScribbleTool"/> class.
    /// </summary>
    /// <param name="name">The name of the tool.</param>
    public ScribbleTool(string name)
      : base(name) {
    }
    #endregion
    ...
    public void MouseMove(MouseEventArgs e) {
      ...
      if (IsActive && doDraw) {
        ...
        Controller.View.PaintGhostLine(MultiPointType.Curve, points);
