...
namespace Netron.Diagramming.Core
{
    ...
    // ----------------------------------------------------------------------
    /// <summary>
    /// An enumeration of the different connector styles that specifies how 
    /// the connector is drawn on the canvas.
    /// </summary>
    // ----------------------------------------------------------------------
    [Serializable()]
    public enum ConnectorStyle
    {
        ...
        // ------------------------------------------------------------------
        /// <summary>
        /// A connector who's backcolor is transparent and a blue 'x' is
        /// drawn (similar to Visio).
        /// </summary>
        // ------------------------------------------------------------------
        Simple
    }
    ...
    /// <remarks>In earlier Netron libraries shapes were defined and loaded 
    /// by means of attributes and reflection. This system is still possible 
    /// and requires only a little bit of work (or you can copy the code from 
    /// older versions).  For simplicity and performance I decided however not 
    /// to use reflection in this version; many people got confused and there 
    /// are certain technicalities involved.  The drawback of this is the fact 
    /// that all shapes are defined in one big assembly and you need to update 
    /// this enum and to recompile when you add new shapes. Since the code is 
    /// open source and most people recompile things anyway this is not really 
    /// a problem.
    /// </remarks>
	/// </summary>
    // ----------------------------------------------------------------------
