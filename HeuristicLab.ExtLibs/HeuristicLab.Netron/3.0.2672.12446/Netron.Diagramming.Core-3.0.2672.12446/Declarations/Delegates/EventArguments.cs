...
namespace Netron.Diagramming.Core {
  #region PaintStyle EventArgs

  // ----------------------------------------------------------------------
  /// <summary>
  /// Provides information about a PaintStyleChanged event.
  /// </summary>
  // ----------------------------------------------------------------------
  public class PaintStyleChangedEventArgs : EventArgs {
    IPaintStyle mPaintStyle;
    FillType mFillType;

    // ------------------------------------------------------------------
    /// <summary>
    /// Gets the paint style that changed.
    /// </summary>
    // ------------------------------------------------------------------
    ...
    /// Constructor.
    /// </summary>
    /// <param name="paintStyle">IPaintStyle: The IPaintStyle that
    /// changed.</param>
    /// <param name="newFillType">FillType: The new fill type.</param>
    // ------------------------------------------------------------------
    public PaintStyleChangedEventArgs(
        IPaintStyle paintStyle,
        FillType newFillType) {
      mPaintStyle = paintStyle;
      mFillType = newFillType;
    }
  }

  #endregion

  #region TextStyle EventArgs

  // ----------------------------------------------------------------------
  /// <summary>
  /// Provides information about a TextStyleChanged event.
  /// </summary>
  // ----------------------------------------------------------------------
  public class TextStyleChangedEventArgs : EventArgs {
    ITextStyle mTextStyle;

    // ------------------------------------------------------------------
    /// <summary>
    /// Gets the text style that changed.
    /// </summary>
    // ------------------------------------------------------------------
    ...
    /// Constructor.
    /// </summary>
    /// <param name="textStyle">ITextStyle: The ITextStyle that
    /// changed.</param>
    // ------------------------------------------------------------------
    public TextStyleChangedEventArgs(ITextStyle textStyle) {
  ...
  public sealed class EntityMenuEventArgs : EventArgs {
    ...
    /// </summary>
    private ToolStripItem[] additionalItems;
    #endregion;
    ...
    public ToolStripItem[] AdditionalItems {
      get {
  ...
  #region PageEventArgs

  // ----------------------------------------------------------------------
  /// <summary>
  /// Provides information about a page event (page added, current page
  /// changed, etc.).
  /// </summary>
  // ----------------------------------------------------------------------
  public sealed class PageEventArgs : EventArgs {
    ...
    // ------------------------------------------------------------------
    /// <summary>
    /// Gets the page for the event argument.
    /// </summary>
    // ------------------------------------------------------------------
    public IPage Page {
      get {
