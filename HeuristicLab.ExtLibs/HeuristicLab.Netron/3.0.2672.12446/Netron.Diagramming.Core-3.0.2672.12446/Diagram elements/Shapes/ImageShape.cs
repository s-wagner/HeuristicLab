...
namespace Netron.Diagramming.Core {
  ...
  public partial class ImageShape : SimpleShapeBase {
    ...
    /// </summary>
    // ------------------------------------------------------------------
    protected const double imageShapeVersion = 1.0;
    ...
    public override ToolStripItem[] Menu() {
      ...
      item.Click += new EventHandler(OnResetImageSize);
    ...
    public override void Paint(Graphics g) {
      ...
      if (mImage == null) {
        ...
        g.DrawString("Image shape", ArtPalette.DefaultFont, Brushes.Black, Rectangle.X + (Rectangle.Width / 2), Rectangle.Y + 3, sf);
      } else
