...
namespace Netron.Diagramming.Core
{
	 ...
	 public partial class ComplexRectangle : ComplexShapeBase, IAdditionCallback
	{
        ...
        /// </summary>
        // ------------------------------------------------------------------
        protected const double complexRectangleVersion = 1.0;
        ...
        public override double Version
        {
            get
            {
                return complexRectangleVersion;
            }
        }
		...
		public override void Paint(System.Drawing.Graphics g)
		{
			...
			if(Hovered)
				g.DrawRectangle(ArtPalette.HighlightPen,Rectangle);
			else
                g.DrawRectangle(ArtPalette.BlackPen, Rectangle);
			//the connectors
