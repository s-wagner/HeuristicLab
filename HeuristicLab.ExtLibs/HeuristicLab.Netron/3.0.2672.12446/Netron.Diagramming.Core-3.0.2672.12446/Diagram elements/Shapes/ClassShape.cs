...
namespace Netron.Diagramming.Core {
  // ----------------------------------------------------------------------
  /// <summary>
  /// The typical shape shipping with Visual Studio 2005 in the class 
  /// designer.
  /// </summary>	
  // ----------------------------------------------------------------------
  [Shape(
  ...
  public partial class ClassShape : ComplexShapeBase {
    ...
    /// </summary>
    // ------------------------------------------------------------------
    protected const double classShapeVersion = 1.0;

    private Color mHeadColor = ArtPalette.RandomLowSaturationColor;
    ...
    // ------------------------------------------------------------------
    /// <summary>
    /// the pen used to draw the edge of the shape, which is switching 
    /// between the highlighted and normal state. 
    /// </summary>
    // ------------------------------------------------------------------
    private Pen pen;
    ...
    // ------------------------------------------------------------------
    /// <summary>
    /// The collection of <see cref="FolderMaterial"/> folders displayed 
    /// when the shape is in <see cref="BodyType.List"/> mode.
    /// </summary>
    // ------------------------------------------------------------------
    private CollectionBase<FolderMaterial> mFolders =
        new CollectionBase<FolderMaterial>();
    ...
    // ------------------------------------------------------------------
    /// <summary>
    /// Initializes a new instance of the <see cref="T:ClassShape"/> 
    /// class.
    /// </summary>
    // ------------------------------------------------------------------
    public ClassShape()
    ...
    public override void Paint(Graphics g) {
      ...
      g.DrawString(mTitle, ArtPalette.DefaultBoldFont, Brushes.Black, new Rectangle(Rectangle.X + 20, Rectangle.Y + 5, Rectangle.Width - 45, 27));
      g.DrawString(mSubTitle, ArtPalette.DefaultFont, Brushes.Black, new RectangleF(Rectangle.X + 20, Rectangle.Y + 35, Rectangle.Width - 10, 30), sf);
