...
namespace Netron.Diagramming.Core {
  ...
  public partial class ClickableIconMaterial : IconMaterial, IMouseListener, IHoverListener {
    ...
    /// ClickableIconMaterial.
    /// </summary>
    // ------------------------------------------------------------------
    protected double clickableIconMaterialVersion = 1.0;
    ...
    public override double Version {
      get {
        return clickableIconMaterialVersion;
      }
    }
    ...
    public ClickableIconMaterial(string resourceLocation)
