...
namespace Netron.Diagramming.Core {
  ...
  /// </summary>
  public partial class ClickableIconLabelMaterial :
      IconLabelMaterial,
      IMouseListener,
      IHoverListener {
    #region Fields
    ...
    /// ClickableIconLabelMaterial.
    /// </summary>
    // ------------------------------------------------------------------
    protected double clickableIconLabelMaterialVersion = 1.0;
    ...
    public override double Version {
      get {
        return clickableIconLabelMaterialVersion;
      }
    }
    #endregion
