...
namespace Netron.Diagramming.Core {
  ...
  /// </summary>
  public partial class ClickableLabelMaterial :
      LabelMaterial,
      IMouseListener,
      IHoverListener {
    ...
    /// ClickableLabelMaterial.
    /// </summary>
    // ------------------------------------------------------------------
    protected double clickableLabelMaterialVersion = 1.0;
    ...
    public override double Version {
      get {
        return clickableLabelMaterialVersion;
      }
    }

    // ------------------------------------------------------------------
    /// <summary>
    /// Gets or sets the URL of this clickable material. Note that the 
    /// material can handle more than just Url's by overriding the mouse 
    /// event handlers.  Settings this property is just a convenient way 
    /// to accelerate the development or customization of shapes.
    /// </summary>
    /// <value>The URL.</value>
    // ------------------------------------------------------------------
    public string Url {
