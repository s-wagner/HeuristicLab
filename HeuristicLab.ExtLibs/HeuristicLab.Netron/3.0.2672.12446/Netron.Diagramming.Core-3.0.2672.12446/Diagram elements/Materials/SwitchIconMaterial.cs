...
namespace Netron.Diagramming.Core {
  public partial class SwitchIconMaterial : ClickableIconMaterial {
    ...
    /// </summary>
    // ------------------------------------------------------------------
    protected double switchIconMaterialVersion = 1.0;
    ...
    public override double Version {
      get {
        return switchIconMaterialVersion;
      }
    }
  ...
  // ----------------------------------------------------------------------
  /// <summary>
  /// The two type of bitmaps intrinsically defined by the 
  /// <see cref="SwitchIconMaterial"/>
  /// </summary>
  // ----------------------------------------------------------------------
