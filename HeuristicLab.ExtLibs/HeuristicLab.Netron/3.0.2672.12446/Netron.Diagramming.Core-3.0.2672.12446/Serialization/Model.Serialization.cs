...
namespace Netron.Diagramming.Core {
  ...
  public partial class Model : ISerializable, IXmlSerializable, IDeserializationCallback {
    ...
    protected Model(SerializationInfo info, StreamingContext context) {
      ...
      double version = info.GetDouble("ModelVersion");

      mPages = info.GetValue(
          "Pages",
          typeof(CollectionBase<IPage>)) as CollectionBase<IPage>;
    ...
    public void GetObjectData(SerializationInfo info, StreamingContext context) {
      ...
      info.AddValue("ModelVersion", modelVersion);
