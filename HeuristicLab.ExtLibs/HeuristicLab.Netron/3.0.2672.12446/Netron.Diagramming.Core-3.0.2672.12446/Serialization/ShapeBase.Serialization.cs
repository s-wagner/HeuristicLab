...
namespace Netron.Diagramming.Core {
  ...
  public abstract partial class ShapeBase :
    ...
    /*
        ...
        {
            Trace.WriteLine("Starting to serializing the 'ShapeBase' class...");
        }
        [OnSerialized]
        void OnSerialized(StreamingContext context)
        {
            Trace.WriteLine("...serialization of 'ShapeBase' finished");
        }
        */
    #endregion
    ...
    /*
        ...
        {
            Trace.Indent();
            Trace.WriteLine("Starting deserializing the 'ShapeBase' class...");
        }
        [OnDeserialized]
        void OnDeserialized(StreamingContext context)
         {
             Trace.WriteLine("...deserialization of 'ShapeBase' finished");
             Trace.Unindent();
         }
       */
    #endregion
    ...
    public override void GetObjectData(
      ...
      if (Tracing.BinarySerializationSwitch.Enabled) {
        Trace.WriteLine("Serializing the fields of 'ShapeBase'.");
      }
      ...
      info.AddValue(
          "Connectors",
          this.Connectors,
          typeof(CollectionBase<IConnector>));
    ...
    public override void OnDeserialization(object sender) {
      ...
      if (Tracing.BinaryDeserializationSwitch.Enabled)
        Trace.WriteLine("IDeserializationCallback of 'ShapeBase' called.");
    }
