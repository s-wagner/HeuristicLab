...
namespace Netron.Diagramming.Core {
  ...
  public abstract partial class ConnectionBase :
    ...
    /*
        ...
        {
            Trace.WriteLine("Starting to serializing the 'ConnectionBase' class...");
        }
        [OnSerialized]
        void OnSerialized(StreamingContext context)
        {           
            Trace.WriteLine("...serialization of 'ConnectionBase' finished");
        }
        */
    #endregion
    ...
    /*
        ...
        {
            Trace.Indent();
            Trace.WriteLine("Starting deserializing the 'ConnectionBase' class...");
        }
        [OnDeserialized]
        void OnDeserialized(StreamingContext context)
         {
             Trace.WriteLine("...deserialization of 'ConnectionBase' finished");
             Trace.Unindent();
         }
       */
    #endregion
    ...
    public override void GetObjectData(
      ...
      if (Tracing.BinarySerializationSwitch.Enabled) {
        Trace.WriteLine(
            "Serializing the fields of 'ConnectionBase'.");
      }

      base.GetObjectData(info, context);
      info.AddValue("From", this.From, typeof(Connector));
      info.AddValue("To", this.To, typeof(Connector));
      info.AddValue("ConnectionBaseVersion", connectionBaseVersion);
    }
    #endregion
    ...
    public override void OnDeserialization(object sender) {
      ...
      if (Tracing.BinaryDeserializationSwitch.Enabled)
        Trace.WriteLine("IDeserializationCallback of 'ConnectionBase' called.");
    }
