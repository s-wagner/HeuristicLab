  ...
  public partial class Connector :
    ...
    protected Connector(
      ...
      if (Tracing.BinaryDeserializationSwitch.Enabled) {
        Trace.WriteLine("Deserializing the fields of 'Connector'.");
      }

      double version = info.GetDouble("ConnectorVersion");

      myStyle = (ConnectorStyle)info.GetValue(
          "ConnectorStyle",
          typeof(ConnectorStyle));
    }
    #endregion
    ...
    /*
        ...
        {
            Trace.WriteLine("Starting to serializing the 'Connector' class...");
        }
        [OnSerialized]
        void OnSerialized(StreamingContext context)
        {
            Trace.WriteLine("...serialization of 'Connector' finished");
        }
        */
    #endregion
    ...
    /*
        ...
        {
            Trace.Indent();
            Trace.WriteLine("Starting deserializing the 'Connector' class...");
        }
        [OnDeserialized]
        void OnDeserialized(StreamingContext context)
         {
             Trace.WriteLine("...deserialization of 'Connector' finished");
             Trace.Unindent();
         }
       */
    #endregion
    ...
    public override void GetObjectData(
      ...
      if (Tracing.BinarySerializationSwitch.Enabled) {
        Trace.WriteLine("Serializing the fields of 'Connector'.");
      }

      base.GetObjectData(info, context);

      info.AddValue("ConnectorVersion", connectorVersion);
      info.AddValue("ConnectorStyle", myStyle, typeof(ConnectorStyle));
    }
    #endregion
    ...
    public override void OnDeserialization(object sender) {
      ...
      if (Tracing.BinaryDeserializationSwitch.Enabled)
        Trace.WriteLine("IDeserializationCallback of 'Connector' called.");
    }
