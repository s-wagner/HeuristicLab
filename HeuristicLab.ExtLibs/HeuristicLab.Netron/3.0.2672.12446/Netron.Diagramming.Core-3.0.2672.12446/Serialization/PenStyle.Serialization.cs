...
namespace Netron.Diagramming.Core {
  ...
  public partial class PenStyle :
    ...
    protected PenStyle(SerializationInfo info, StreamingContext context) {
      ...
      double version = info.GetDouble("PenStyleVersion");

      mWidth = info.GetSingle("Width");

      mColor = (Color)info.GetValue("Color", typeof(Color));

      mDashStyle = (System.Drawing.Drawing2D.DashStyle)Enum.Parse(
          typeof(System.Drawing.Drawing2D.DashStyle),
          info.GetString("DashStyle"));
    }
    #endregion
    ...
    public virtual void GetObjectData(
      ...
      info.AddValue("PenStyleVersion", penStyleVersion);
