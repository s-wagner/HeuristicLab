...
namespace HeuristicLab.Problems.GeneticProgramming {
  [Plugin("HeuristicLab.Problems.GeneticProgramming","Provides implementations for genetic programming problems such as the artificial ant problem.", "3.3.13.13316")]
