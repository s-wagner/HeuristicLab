...
namespace HeuristicLab.Problems.Instances.ElloumiCTAP {
  internal class ElloumiCTAPDataDescriptor : IDataDescriptor {
    ...
    internal ElloumiCTAPDataDescriptor(string name, string description, string instanceIdentifier, string solutionIdentifier) {
      this.Name = name;
