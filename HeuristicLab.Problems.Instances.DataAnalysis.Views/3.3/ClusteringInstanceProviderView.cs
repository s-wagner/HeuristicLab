...
namespace HeuristicLab.Problems.Instances.DataAnalysis.Views {
  [View("Clustering InstanceProvider View")]
  [Content(typeof(ClusteringInstanceProvider), IsDefaultView = true)]
  public partial class ClusteringInstanceProviderView : DataAnalysisInstanceProviderView<IClusteringProblemData> {

    public new ClusteringInstanceProvider Content {
      get { return (ClusteringInstanceProvider)base.Content; }
      set { base.Content = value; }
    }

    public ClusteringInstanceProviderView() {
      InitializeComponent();
    }
