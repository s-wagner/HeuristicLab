...
namespace HeuristicLab.Optimization.Views {
  /// <summary>
  /// Plugin class for HeuristicLab.Optimization.Views plugin.
  /// </summary>
  [Plugin("HeuristicLab.Optimization.Views", "3.3.14.14190")]
  [PluginFile("HeuristicLab.Optimization.Views-3.3.dll", PluginFileType.Assembly)]
  ...
  [PluginDependency("HeuristicLab.Parameters.Views", "3.3")]
  ...
  public class HeuristicLabOptimizationViewsPlugin : PluginBase {
  }
}
